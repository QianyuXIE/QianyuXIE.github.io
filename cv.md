...
<div class="academic-profile-grid">
  <aside class="academic-sidebar" aria-label="Profile">
    <img class="academic-portrait" src="{{ '/img/Me/passport_photo.jpg' | relative_url }}" alt="Portrait of Qianyu Xie">
    <h1>Qianyu Xie</h1>
    <p class="academic-chinese-name">谢浅羽</p>
    ...
    <a class="academic-cv-link" href="{{ '/assets/files/CV_QianyuXie_cuhksz.pdf' | relative_url }}" target="_blank" rel="noopener noreferrer">Download CV</a>
  </aside>
